...
export default ({ states, fields }) => {
    ...
    const { jobTitle, location, salary, expLevel } = fields

    return (
        <div className="space-y-3">
            <Input labelName="Job title" defaultValue={jobTitle} onInput={(e) => setJobTitle(e.target.value)} />
            ...
            <div>
                <ExpLevel defaultValue={expLevel} data={data} setExpLevel={setExpLevel} />
