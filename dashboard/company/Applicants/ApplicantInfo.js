                                ...
                                <div className="overflow-y-auto max-h-screen pb-12 sm:max-h-full sm:pb-0">
                                    ...
                                    <div>
                                        <div className="flex items-center justify-center space-x-2">
                                            <a href={items.resume} title="Resume" target="_blank" download="Resume" className="inline-block my-4 rounded-md focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500">
                                            ...
                                            <Link href={`/job/${items.job}`}>
                                                <a className="text-gray-500 hover:text-gray-700 p-1 rounded-md focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500">
                                                    View job
                                                </a>
                                            </Link>
                                        </div>
