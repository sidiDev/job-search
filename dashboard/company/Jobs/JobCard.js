...
export default () => {
    return (
        <li className="shadow-md p-3 rounded-md border duration-300 relative hover:shadow-none hover:border-cyan-600">
            <div className="absolute -top-4 right-2 flex space-x-3">
                ...
                <Link href="/dashboard/company/job/full-stack-developer">
