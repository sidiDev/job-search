...
export default ({ data, job }) => {
    ...
    return (
        <aside className="top-3 md:sticky md:h-96">
            <div className="bg-gray-50 p-4 rounded-md space-y-4 grid-cols-2 sm:grid sm:space-y-0 md:space-y-4 md:block">
                <div className="pb-4 border-gray-200 border-b-2 sm:border-0 md:border-b-2">
                ...
                <div className="hidden md:block">
                    <ApplyBtn data={data} id={job._id} w="w-full" />
                </div>
            </div>
        </aside>
    )
